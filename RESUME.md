...
| 符号化の速度 | **2026-09-21 に 99.3 倍 → 12.5 倍**（対 LASzip、全列、四分位 [10.6, 13.8]、幅 4.3〜18.3）。55〜64 節 |
| 復号の速度 | **4.4 倍**（同、四分位 [2.0, 5.3]）。復号は選ばれた 1 本しか通らない。62〜63 節 |
| 走査モデルの変種 | **2026-09-21 に v2/v3/v4 も既定で出す**（65 節）。記号版を標本から守った上で、3 つの標本すべてで悪化ゼロ・3 件が縮んだ。幾何は G-PCC に 8/17 → 9/17 |
